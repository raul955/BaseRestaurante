...
public class Controlador {
	...
	public ModelAndView neww(HttpServletRequest request)
			throws ServletException, SQLIntegrityConstraintViolationException {
	...
	public ModelAndView consulta(HttpServletRequest request)
			throws ServletException, IOException, java.lang.NullPointerException, ClassNotFoundException, SQLException {
	...
	public ModelAndView fin(HttpServletRequest request)
			throws ServletException, IOException, java.lang.NullPointerException, ClassNotFoundException, SQLException {
	...
	public ModelAndView filtrado(HttpServletRequest request)
			throws ServletException, SQLIntegrityConstraintViolationException {
	...
	public ModelAndView cardPeliculas(HttpServletRequest request)
	...
	public ModelAndView informacionPel(HttpServletRequest request)
			throws ServletException, IOException, ClassNotFoundException, SQLException {
	...
	public ModelAndView addCalificaciones(HttpServletRequest request)
			throws ServletException, IOException, ClassNotFoundException, SQLException {
