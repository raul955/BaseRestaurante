...
<body>
	<div align="center" class="row justify-content-center">
		<div class="col-auto">
			...
			<a href="/consultaDir"><input type="submit" value="Volver"
				class="btn btn-outline-danger" /></a>

			<form method="POST" action="finalizar">
				<input type="submit" value="Finalizar"
					class="btn btn-outline-success" /></br> </br> <input name="action"
					value="finalizar" style="visibility: hidden; display: none;">
			</form>
		</div>
